...
var getConfigJson = function(bucketId) {
  return new Promise(function(resolve, reject) {
    request('https://storage.googleapis.com/'+ bucketId+'/configuration.json', function(error, response, body) {
...
var findStorageBucket = function(obj) {
  return new Promise(function(resolve, reject) {
    if (obj.bucketName) {
      ...
      let name = obj.companyName.toLowerCase().replace(/\s/g, '-') + UUID.create();
